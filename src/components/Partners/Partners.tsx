...
const Partners = () => {
    ...
    const getSlidesToShow = () => {
        ...
        const slidesToShow = [];
        if (activeIndex === 0) {
            slidesToShow.push(slides[lastIndex], slides[activeIndex], slides[activeIndex + 1]);
        } else if (activeIndex === lastIndex) {
            slidesToShow.push(slides[activeIndex - 1], slides[activeIndex], slides[0]);
        } else {
            slidesToShow.push(slides[activeIndex - 1], slides[activeIndex], slides[activeIndex + 1]);
        }
        return slidesToShow;
    };
    return (
